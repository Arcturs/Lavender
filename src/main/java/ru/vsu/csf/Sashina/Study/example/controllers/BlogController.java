...
import ru.vsu.csf.Sashina.Study.example.repository.PostRepository;
...
public class BlogController {
    ...
    @GetMapping("/blog/{id}")
    public String blockDetails(@PathVariable(value = "id") long id, Model model) {
    ...
    public String blockPostUpdate(@RequestParam String title, @RequestParam String anons,
    ...
    public String blockPostUDelete(@PathVariable(value = "id") long id, Model model) {
        Post post = postRepository.findById(id).orElseThrow();
